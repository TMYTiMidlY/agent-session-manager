 ...
 *
 * The data layer is the shared `ParsedSession` from `@agent-session-manager/core`,
...
export interface RenderMarkdownOptions {
  ...
  summary?: string;
  /** Footer line; `""` disables it. Default: agent-session-manager credit. */
  footer?: string;
...
export function renderSessionMarkdown(session: ParsedSession, opts: RenderMarkdownOptions = {}): string {
  ...
  const footer = opts.footer === ""
    ? ""
    : `\n---\n\n<sub>${opts.footer ?? "Generated by [agent-session-manager](https://github.com/TMYTiMidlY/agent-session-manager)"}</sub>\n`;
